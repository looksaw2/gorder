...
const file_orderpb_order_proto_rawDesc = "" +
	"\n" +
	"\x13orderpb/order.proto\x12\aorderpb\x1a\x1bgoogle/protobuf/empty.proto\">\n" +
	...
	"\vUpdateOrder\x12\x0e.orderpb.Order\x1a\x16.google.protobuf.EmptyB6Z4github.com/looksaw/gorder-v2/common/genproto/orderpbb\x06proto3"
...
var file_orderpb_order_proto_depIdxs = []int32{
	0, // 0: orderpb.CreateOrderRequest.items:type_name -> orderpb.ItemWIthQuantity
